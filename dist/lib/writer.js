...
function compareStatisticsBuffer(potential, statistics) {
    const result = {};
...
function compareStatisticsGtLt(potential, statistics) {
    const result = {};
    // === 1 means the first value is greater
...
function compareStatistics(potential, statistics) {
    if (parquet_types.isUint8Array(potential))
        return compareStatisticsBuffer(potential, statistics);
